  ...
  return (
    <div name='Home' className="bg-gray-300 grid lg:grid-cols-2 2xl:grid-cols-5">
        <div className="x-4 py-2 max-w-md mx-auto sm:max-w-xl lg:px-4 lg:py-2 2xl:col-span-2">
            ...
            alt="SEVENTEEN" />
            <img className="mt-8 rounded-xl shadow-md sm:object-cover object-center sm:mt-12 sm:h-64 sm:w-full lg:hidden" src="https://res.heraldm.com/content/image/2023/03/31/20230331000538_0.jpg" 
            alt="SVT" />
            <h1 className="mt-4 text-2xl text-cyan-600 font-bold sm:mt-12 sm:text-4xl lg:text-3xl">SEVENTEEN (세븐틴) 
            <span className=" m-2 text-rose-600">DREAM</span> 
            Official MV</h1>
            <p className="mt-4 text-sm ">Dream is the third Japanese-language extended play by South Korean boy band 
            <span class=" m-1 font-extrabold">Seventeen</span>.<br /> It was released on November 9, 2022, through Hybe Labels Japan.
            <br /> It contains one original song, 
            <span class=" m-1 text-rose-600 font-extrabold">Dream</span>, 
            the Japanese version of two songs originally released in Korean, 
            <span class=" m-1 font-semibold">Rock with You and All My Love</span>, 
            and the holiday version of the English track <span class=" m-1 font-semibold">Darling</span>.<br /> 
            The EP has been marketed as the band's "first" Japanese-language EP despite Seventeen having recorded two previous Japanese EPs, <span class=" m-0 font-semibold">We Make You and 24H</span>, 
            which were officially classified as "mini-album".</p>
        
            <div className=" grid grid-cols-2 mt-6 sm:mt-6">
            <a className=" btn-primary " href="https://www.youtube.com/watch?v=6H8QHeC_VPs">Youtube</a>
            <a className=" btn-secondary " href="https://open.spotify.com/track/0PwknbaUVwXJSmRh7qSfyi?si=7c0d331cc75045d4">Spotify</a>
            </div>
        </div>
  
        <div className="hidden relative lg:block">
            <img className="absolute inset-0 w-full h-full object-cover object-center 2xl:col-span-3" src="https://res.heraldm.com/content/image/2023/03/31/20230331000538_0.jpg" 
            alt="SVT" />
        </div> 
    </div>
  )
